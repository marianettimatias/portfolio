    ...
    <header>
      <div className="container header__container">
        ...
        <p className='header__p'>
          ...
          <br />
          Soy nuevo en el mundo IT, pero en HENRY, tuve la suerte de trabajar en una SPA (single page application) usando muchas tecnologías como #JavaScript #React #Redux #CSS #Git #Node #Sequelize #PostgreSQL.
        </p>
